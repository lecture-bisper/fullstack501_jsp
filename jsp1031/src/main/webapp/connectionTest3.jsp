...
<div class="container mt-5">
  ...
  <div>
    <%
      ...
      String dbUserId = application.getInitParameter("MySqlUserId");
      String dbUserPw = application.getInitParameter("MySqlUserPw");
      String dbOpt1 = application.getInitParameter("MySqlOpt1");
      String dbOpt2 = application.getInitParameter("MySqlOpt2");

      dbUrl += "?" + dbOpt1 + "&" + dbOpt2;

      JDBConnect jdbCon = new JDBConnect(driver, dbUrl, dbUserId, dbUserPw);
